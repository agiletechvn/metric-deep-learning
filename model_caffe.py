...
class CNN_caffe():
    ...
    def __init__(self, name, prototxt, caffemodel):
        ...
        if name == 'googlenet':
            ...
            raise ValueError(
                'Network not found. Supported networks for Caffe framework: googlenet, vgg, resnet')
    ...
    def extract(self, image_tensor, batch_sz):
        ...
        for i in range(preprocessed_images.shape[0] / batch_sz + 1):
